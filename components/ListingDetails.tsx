...
interface ListingDetailsProps {
  ...
  onBack: () => void;
  onMessage: () => void;
  onOpenChat?: (chatId: string) => void; // Pour ouvrir directement un chat spécifique
  isFavorite: boolean;
...
const ListingDetails: React.FC<ListingDetailsProps> = ({ listing, onBack, onMessage, onOpenChat, isFavorite, onToggleFavorite, currentUser, mechanics, listings, onSelectListing }) => {
